...
/* harmony default export */ const vue_suggestionvue_type_script_lang_js_ = ({
  ...
  props: {
    ...
    suggestionOptions: {
      type: Object,
      default: function _default() {
        return getDefault('suggestionOptions');
      }
    }
  },
  data: function data() {
  ...
  computed: {
    itemGroups: function itemGroups() {
      return this.items.reduce(function (prv, crr, index) {
        ...
        var item = _objectSpread2(_objectSpread2({}, crr), {}, {
          vsItemIndex: index
        });
...
var src_excluded = ["suggestionOptions", "inputOptions"],
    _excluded2 = ["suggestionOptions", "inputOptions"];
...
function install(app) {
  ...
  var customSuggestionOptions = customOptions.suggestionOptions,
      customInputOptions = customOptions.inputOptions,
      otherCustomOptions = _objectWithoutProperties(customOptions, src_excluded);

  var defaultSuggestionOptions = defaultOptions.suggestionOptions,
  ...
  utils.options = _objectSpread2(_objectSpread2({
    ...
    suggestionOptions: _objectSpread2(_objectSpread2({}, defaultSuggestionOptions), customSuggestionOptions)
