...
__all__ = [ '__MIDL_IWinTypes_0009', 'IAccIdentity', 'ANNO_THIS',
           'ANNO_CONTAINER', '_RemotableHandle', 'AnnoScope',
           'IAccessibleHandler', 'IAccPropServer', 'wireHMENU',
           'IAccessible', 'IAccPropServices', 'CAccPropServices']
